...
from common.mixste_transfer import *
...
class D3DP(nn.Module):
    ...
    def ddim_sample_train(self, inputs_2d, inputs_3d, clip_denoised=True, do_postprocess=True, input_2d_flip=None):
    ...
    def forward(self, input_2d, input_3d, input_2d_flip=None):
        ...
        if self.is_train:
            results = self.ddim_sample_train(input_2d, input_3d, input_2d_flip=input_2d_flip)
